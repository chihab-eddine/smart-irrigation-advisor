/**
 * Icon — a single SVG renderer for a curated Lucide-style icon set.
 * Stroke-based, 24×24 viewBox, currentColor. Pass `name` and `className`.
 */
...
const paths = {
  ...
  leaf: <><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19.2 2.3c1.7 4.7 0 11-6.5 15.7A7 7 0 0 1 11 20z"/><path d="M2 21c0-3 1.85-5.36 5.08-6"/></>,
  sun: <><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/></>,
  cloud: <path d="M17.5 19a4.5 4.5 0 1 0-1.4-8.8 6 6 0 0 0-11.6 1.3A4 4 0 0 0 6 19h11.5z"/>,
  ...
  checkCircle: <><circle cx="12" cy="12" r="10"/><polyline points="9 12 12 14 16 9"/></>,
